...
const fetchClaims = async (matNrs, useMhNr) => {
    ...
    const response = await srv.get(`/api/v1/datasphere/consumption/relational/IT_MAIN01/C1VF_WTY_0002/C1VF_WTY_0002?$select=AU_CLMNO,_BIC_WTYMM_058,WM_PROD_D&$apply=filter(${filterQuery})/groupby((AU_CLMNO,_BIC_WTYMM_058,WM_PROD_D))`, matNrs)
